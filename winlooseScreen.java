...
public class winlooseScreen implements Screen {
    private final Main game;
    private Stage stage;
    private Skin skin;
    private Texture winTexture; // Texture for the background image

    public winlooseScreen(Main game) {
        this.game = game;
    }
    ...
    public void show() {
        ...
        winTexture = new Texture(Gdx.files.internal("win_image.jpeg")); // Replace with your jpeg file

        // Create the Exit button
        TextButton exitButton = new TextButton("Exit to Level Screen", skin);
        ...
        Image background = new Image(winTexture);
